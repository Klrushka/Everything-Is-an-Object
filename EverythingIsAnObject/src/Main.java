...
public class Main {
    public static void main(String[] args) {
       ...
       по умолчанию.*/
        ...
        // Task 8
        /*апишите программу, которая демонстрирует, что независимо от количества
        созданных объектов класс содержит только один экземпляр поля static.*/
        TestObject t1 = new TestObject();
        TestObject t2 = new TestObject();
        System.out.println("Static field t1: " + t1.getStaticField() + '\n' +
                "Static field t2: " + t2.getStaticField() + '\n');
